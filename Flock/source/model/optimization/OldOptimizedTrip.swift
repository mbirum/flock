...
class OldOptimizedTrip: Equatable {
    ...
    static func isRequestable() -> Bool {
        return OldOptimizedTrip.queue.count == 0
    }
...
//            OldOptimizedTrip.queue = []
//            return
//        }
        if OldOptimizedTrip.queue.count > 0 {
            return
        }
//        OldOptimizedTrip.queue.append(OptimizationRequest())
...
//        printTripString()
    ...
    static func == (lhs: OldOptimizedTrip, rhs: OldOptimizedTrip) -> Bool {
